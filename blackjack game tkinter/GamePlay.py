...
class Game():
    def __init__(self,win):
        ...
        score = winnings = 0
        money = int(input('How much money do you want to spend? (give in numbers)("YOUR BUST LOSES $10000") :'))
        while(TypeError == True):
            print('Enter the amount you have correctly in numbers')
            money = int(input('Enter the amount you have in numbers(should be more than 500) :'))
        ...
        winnings_view = Scorebox(win, Point(310,20),"Won:",winnings)
        ...
        newdeck_Button = Button(win, Point(112,33), 50, 12,10,"DECK", False)
        ...
        while not quit_Button.clicked(p):
            ...
            # User can pass and take winnings
                ...
                score,winnings,money = gameUpdates('gameover',score,winnings,money-1000,score_view,winnings_view,bank_view,True)
                buttonUpdates('gameover',buttons)
